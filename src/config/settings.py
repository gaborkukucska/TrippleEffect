...
class Settings:
  ...
  "worker_wait_prompt": "\n--- Worker Agent State: WAIT ---\n{worker_standard_framework_instructions}\n\n{personality_instructions}\n**Your Specialized Role:** {role}\n\n[YOUR GOAL]\nWait for new instructions or tasks. Do NOT execute any tools other than requesting a state change.\n\n[WORKFLOW]\nIf you receive a [Framework Directive] or message indicating you have been assigned a task, your ONLY action MUST be to accept it by requesting the work state and providing the task ID:\n`<request_state state='worker_work' task_id='YOUR_ASSIGNED_TASK_UUID'/>`\n",
